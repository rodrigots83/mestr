...
### Rodando uma árvore de decisão com repeated k-fold cross-validation -- 2ª TENTATIVA
...
### Rodando uma árvore de decisão com repeated k-fold cross-validation -- 3ª TENTATIVA
